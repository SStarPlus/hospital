...
public class ShiroSpringConfig {
    ...
    public ShiroFilterFactoryBean shirFilter(DefaultWebSecurityManager securityManager) {
        ...
        filterChainDefinitionMap.put("/prosceniumForgetPas", "anon");
        filterChainDefinitionMap.put("/diplomaProject", "anon");
        filterChainDefinitionMap.put("/articlePage", "anon");
        filterChainDefinitionMap.put("/noticePage", "anon");
        filterChainDefinitionMap.put("/articleDetailsPage", "anon");
        filterChainDefinitionMap.put("/officePage", "anon");
        filterChainDefinitionMap.put("/officeDetailsPage", "anon");
        filterChainDefinitionMap.put("/allDoctorPage", "anon");
        filterChainDefinitionMap.put("/doctorPage", "anon");
        filterChainDefinitionMap.put("/doctorDetailsPage", "anon");
        filterChainDefinitionMap.put("/visitPage", "anon");
        filterChainDefinitionMap.put("/officeVisitPage", "anon");
        //发送密码接口
